  ...
  return (
    <>
      ...
      <div className={`sidemenu fixed-top ${isToggled ? 'active' : ''}`} >
        <ul>
          <li><a href='/user' className='active'> <img src={Dashboard} alt="Dashboard" /> <span>Dashboard</span></a></li>
          <li><a href='/market'> <img src={Market} alt="Market" /> <span>Market</span> </a></li>
          <li><a href='/wallet'> <img src={Wallet} alt="Wallet" /> <span>Wallet</span></a></li>
          <li><a href='/stacking'> <img src={Staking} alt="Staking" /> <span>Staking</span></a></li>
          <li><a href='/loans'> <img src={Loans} alt="Loans" /> <span>Loans</span></a></li>
          <li><a href='@!'> <img src={Settings} alt="Settings" /> <span>Settings</span></a></li>
          <li><a href='/profile'> <img src={user} alt="Profile" /> <span>Profile</span></a></li>
